...
def read_images(images_path, batch_size=30):
...
def FeatureNetMetrics():
    ...
    for gt in gan_type:  # '../work_dir/generator/dragan'
        for cls_ in os.listdir(gt):  # Cr
            ...
            # write log
            log_path = gt + '/' + cls_ + "/FeatureNet_metrics.txt"
...
def ImageMetrics():
    ...
    for gt in gan_type:  # '../work_dir/generator/dragan'
        for cls_ in os.listdir(gt):  # Cr
            ...
            make_custom_stats(custom_name, real_fdir=real_path)
            ...
            # write log
            log_path = gt + '/' + cls_ + "/Image_metrics.txt"
