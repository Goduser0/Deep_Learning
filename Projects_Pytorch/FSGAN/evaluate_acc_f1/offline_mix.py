...
parse.add_argument("--image_dir", type=str, default="../dataset/SDPCB/PCB-50-r64-pad")
parse.add_argument("--mix_ratio", type=float, default= 1 / 2, help="sys : pad = a / b")
...
train_num = len(os.listdir(P_img_path + '/Cs'))
