...
do
    ...
    python backbone.py \
        --gpu_ids 1 \
        --model_name ${class} \
        --train_path ../dataset/NEU/NEU-30-r64/train \
...
do
    ...
    python backbone.py \
        --gpu_ids 1 \
        --model_name ${class} \
        --train_path ../dataset/NEU/NEU-30-r64-pad/color \
        --test_path ../dataset/NEU/NEU-30-r64/test \
        --n_epochs 50 \
        --log_name color_${i} \
        --batch_size 16 \
...
do
    ...
    python backbone.py \
        --gpu_ids 1 \
        --model_name ${class} \
        --train_path ../dataset/NEU/NEU-30-r64-pad/geometric \
        --test_path ../dataset/NEU/NEU-30-r64/test \
        --n_epochs 50 \
...
do
    ...
    python backbone.py \
        --gpu_ids 1 \
        --model_name ${class} \
        --train_path ../dataset/NEU/NEU-30-r64-pad/geo-color \
        --test_path ../dataset/NEU/NEU-30-r64/test \
        --n_epochs 50 \
        --log_name geometric_${i} \
        --batch_size 16 \
...
do
    ...
    python backbone.py \
        --gpu_ids 1 \
        --model_name ${class} \
        --train_path ../dataset/NEU/NEU-30-r64-pad/train_1500_mix0.5_wgan-gp \
        --test_path ../dataset/NEU/NEU-30-r64/test \
        --n_epochs 50 \
