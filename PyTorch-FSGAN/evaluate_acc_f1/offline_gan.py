...
def generator_samples(model_path, n=1500):
    ...
    if int(epoch) > 9600:
        generator_path = "../work_dir_pcb/generator_50_num50/" + gan_type + \
        ...
        for i, img in tqdm(enumerate(fake_imgs.cpu())):
            save_image(img, generator_path + "/%d.png" % i, normalize=True)
...
def make_gan_all(type_="wgan-gp", lambda_gan_g=5e-2):
    source_root = "../work_dir_pcb3/generator_50_num1500/" + type_
    target_root = "../dataset/SDPCB/PCB-50-r64-pad/" + type_ + '-my'
    for cls_ in ["Cs", "Sh"]:
...
if __name__ == '__main__':
    # generator_samples_epoch("../work_dir_pcb/checkpoints/wgan-gp")
