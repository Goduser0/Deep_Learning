...
#! train 50-shot 70-shot 90-shot 110-shot 130-shot 150-shot on all models
...
#! test 50-shot 70-shot 90-shot 110-shot 130-shot 150-shot on all models
root_path="/home/zhouquan/MyDoc/Deep_Learning/My_TAOD/Train_Classification/results/PCB_200"
mapfile -t subfolders < <(find "$root_path" -mindepth 1 -maxdepth 1 -type d)
for folder in "${subfolders[@]}"; do
  $ENV --mode "test" --gpu_id "1" --test_model_path "$folder/models/100.pth"
done
