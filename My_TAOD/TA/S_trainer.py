...
# data loader
dataset_list = ['NEU_CLS', 'PCB_Crop', 'PCB_200']
parser.add_argument("--dataset_class", type=str, default='PCB_Crop', choices=dataset_list)
parser.add_argument("--data_path", 
                    type=str, 
                    default="/home/zhouquan/MyDoc/Deep_Learning/My_TAOD/dataset/PCB_Crop/0.7-shot/train/1.csv")
...
for epoch in tqdm.tqdm(range(1, config.num_epochs + 1), desc=f"On training"):
    ...
    for i, data in enumerate(data_iter_loader):
        ...
        loss_recon_features_common.backward()
        loss_recon_features_unique.backward()
        ...
        D_features = torch.concat([D_z, features_unique_raw], dim=1) # [B, 128]
