...
def ConGAN_SampleGenerator(G_path, sample_size=100):
    #  G_path = "My_TAOD/TA/TA_Results/ConGAN/DeepPCB_Crop 0 2025-01-02_20-21-36/models/10000_net_g.pth"    
    device = "cuda:1"
    G = ConGAN_Generator()
    ...
    img_save_csv = f"My_TAOD/TA/TA_Results/ConGAN/{G_time}/samples/{dirname}/generate_imgs.csv"
...
if __name__ == "__main__":
    ...
    #         fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 100)
    #         # print(fake_path)
    ...
    # 生成1500张样本
    for G_path in G_path_list:
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 30)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 70)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 200)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 300)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 400)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 500)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 1000)
        # fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 1500)
        fake_path = ConGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 2000)