...
def DCGAN_SampleGenerator(G_path, batch_size=100):
    ...
    img_save_df.to_csv(f"My_TAOD/TA/TA_Results/DCGAN/{G_time}/samples/{dirname}/generate_imgs.csv")
    print("Generate Done!!!")
    
if __name__ == "__main__":
    G_path = "My_TAOD/TA/TA_Results/DCGAN/DeepPCB_Crop 0 2024-12-30_17-45-01/models/10000_net_g.pth"
    DCGAN_SampleGenerator(G_path)