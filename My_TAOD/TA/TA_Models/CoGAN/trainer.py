...
from model import CoGAN_Generator, CoGAN_Discriminator, Xavier_Weights_Init
...
# Save Directories
parser.add_argument("--save_rootdir", type=str, default="My_TAOD/TA/TA_Results/CoGAN")
# Tar data loader
