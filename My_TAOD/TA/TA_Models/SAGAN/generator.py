...
from model import SAGAN_Generator
import sys
...
def SAGAN_SampleGenerator(G_path, sample_size=100):
    ...
    os.makedirs(f"My_TAOD/TA/TA_Results/SAGAN/{G_time}/samples/{dirname}", exist_ok=False)
    ...
    for batch_size in split_list:
        ...
        for img in tqdm.tqdm(imgs):
            ...
            filename = f"{i}.jpg"
            img_path = f"My_TAOD/TA/TA_Results/SAGAN/{G_time}/samples/{dirname}/{filename}"
            img.save(img_path)
...
if __name__ == "__main__":
    root_path = 'My_TAOD/TA/TA_Results/SAGAN'
    ...
    #         fake_path = SAGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 100)
    #         print(fake_path)
    ...
    # 生成1500张样本
    for G_path in G_path_list:
        fake_path = SAGAN_SampleGenerator(f"{G_path}/models/10000_net_g.pth", 1500)