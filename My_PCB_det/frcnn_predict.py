...
from utils import cvtColor, get_classes, get_new_img_size, resize_image, preprocess_input
...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : 'My_PCB_det/logs/2024-06-23_16-53-23/best_epoch_weights.pth',
